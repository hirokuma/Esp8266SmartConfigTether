...
class DatumCode implements ICodeData {
     ...
     */
    DatumCode(String apSsid, String apBssid, String apPassword,
    ...
    public byte[] getBytes() {
        ...
        for (int i = 0; i < mDataCodes.length; i++) {
            System.arraycopy(mDataCodes[i].getBytes(), 0, datumCode,
                    i * DataCode.DATA_CODE_LEN, DataCode.DATA_CODE_LEN);
        }
        return datumCode;
    }
    ...
    public String toString() {
        ...
        for (byte ch : dataBytes) {
            String hexString = ByteUtil.convertByte2HexString(ch);
            sb.append("0x");
